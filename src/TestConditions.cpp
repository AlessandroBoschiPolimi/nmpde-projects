...
const ForcingTermType null_forcing_term = [](const Point<dim> &) {
	Tensor<1, dim> res;
	res[0] = 0;
	res[1] = 0;
	res[2] = 0;	
...
// 				    = (0,0,0)            otherwise 
const ForcingTermType bend_rod = [](const Point<dim> &p) {
	Tensor<1, dim> res;
	res[0] = 0;
...
const ForcingTermType cube_squeeze = [](const Point<dim> &p) {
	Tensor<1, dim> res;
	if (p[0] > 0.5) res[0] = -1;
	else            res[0] = +1;
	if (p[1] > 0.5) res[1] = -1;
...
const ForcingTermType cube_tear = [](const Point<dim> &p) {
	Tensor<1, dim> res;
	if (p[0] > 0.5) res[0] = +1;
	else            res[0] = -1;
	if (p[1] > 0.5) res[1] = +1;
...
const ForcingTermType cube_squeeze_zm_little = [](const Point<dim> &) {
	Tensor<1, dim> res;
	res[0] = 0;
	res[1] = 0;
	res[2] = -0.2;
...
const ForcingTermType cube_squeeze_zm_lot = [](const Point<dim> &) {
	Tensor<1, dim> res;
	res[0] = 0;
	res[1] = 0;
	res[2] = -2;
